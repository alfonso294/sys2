      ...
      <legend>Personal Information</legend>  
        ...
        <div class="form-group col-md-4">
            ...
            <select id="barangay" class="form-control" name="barangay">
              ...
              <option class="Manila">San Nicolas: Barangay 668</option> 
              <option class="Manila">San Nicolas: Barangay 669</option> 
              <option class="Manila">San Nicolas: Barangay 670</option> 
              <option class="Manila">San Nicolas: Barangay 671</option> 
              <option class="Manila">San Nicolas: Barangay 672</option> 
              <option class="Manila">San Nicolas: Barangay 673</option> 
              <option class="Manila">San Nicolas: Barangay 674</option> 
              <option class="Manila">San Nicolas: Barangay 675</option> 
              <option class="Manila">San Nicolas: Barangay 676</option> 
              <option class="Manila">San Nicolas: Barangay 681</option> 
              <option class="Manila">San Nicolas: Barangay 682</option> 
              <option class="Manila">San Nicolas: Barangay 683</option> 
              <option class="Manila">San Nicolas: Barangay 684</option> 
              <option class="Manila">San Nicolas: Barangay 685</option> 
              <option class="Manila">San Nicolas: Barangay 686</option> 
