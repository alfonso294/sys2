        ...
        <div class="form-row">
                 ...
                 <div class="form-group col-md-4">
                  ...
                  <select id="city" class="form-control" name="city" required>
                    ...
                    <option class="Ilocos-Sur">Gregorio del Pilar</option>
                    ...
                    <option class="Ilocos-Sur">San Emilio</option>
                    <option class="Ilocos-Sur">San Esteban</option>
                    <option class="Ilocos-Sur">San Ildefonso</option>
                    <option class="Ilocos-Sur">San Juan</option>
                    <option class="Ilocos-Sur">San Vicente</option>
                    <option class="Ilocos-Sur">Santa</option>
                    <option class="Ilocos-Sur">Santa Catalina</option>
                    <option class="Ilocos-Sur">Santa Cruz</option>
                    <option class="Ilocos-Sur">Santa Lucia</option>
                    <option class="Ilocos-Sur">Santa Maria</option>
                    <option class="Ilocos-Sur">Santiago</option>
                    <option class="Ilocos-Sur">Santo Domingo</option>
